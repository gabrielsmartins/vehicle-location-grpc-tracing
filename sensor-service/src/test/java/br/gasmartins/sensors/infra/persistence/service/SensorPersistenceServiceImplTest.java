...
class SensorPersistenceServiceImplTest {
    ...
    private SensorElasticSearchRepository repository;

    @BeforeEach
    public void setup() {
        this.repository = mock(SensorElasticSearchRepository.class);
    ...
    public void givenVehicleIdAndIntervalWhenExistsThenReturnSensorDataPage() {
        ...
        var page = this.service.findByVehicleId(id, pageRequest);
